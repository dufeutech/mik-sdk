...
<CardGrid>
  <Card title="Type-Safe Routing" icon="pencil">
    Define routes with automatic path, query, and body extraction using derive
    macros.
  </Card>
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Build your first handler in minutes"
  />
  <LinkCard
    title="Routing"
    href="/guides/routing/"
    description="Learn the routing system"
  />
  <LinkCard
    title="API Reference"
